...
public class ContactDataTests extends TestBase {
  ...
  public void ensurePrecondition() {
    ...
    if (app.contact().all().size() == 0) {
      app.contact().create(new ContactDate().withFirstname("Test1").withLastname("Testovii").withHomephone("89652512365").withMobile("89277465676").withWorkphone("89541251365")
              .withEmail("test@test.com").withEmail2("test@test12.com").withEmail3("test@test123.com").withAddress("Moscov").withAddress2("Piter").withGroup("Test"), true);
    }
  }
  @Test
